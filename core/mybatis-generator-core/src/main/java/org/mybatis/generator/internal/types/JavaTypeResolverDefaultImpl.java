...
public class JavaTypeResolverDefaultImpl implements JavaTypeResolver {
	Logger log = Logger.getLogger(JavaTypeResolverDefaultImpl.class.getName());
	...
	public JavaTypeResolverDefaultImpl() {
		...
		typeMap.put(Types.INTEGER, new JdbcTypeInformation("BIT", //$NON-NLS-1$
	...
	public FullyQualifiedJavaType calculateJavaType(IntrospectedColumn introspectedColumn) {
		...
		if("refund_request".equals(introspectedColumn.getActualColumnName())){
			log.info("xxx");
		}
		if (jdbcTypeInformation == null) {
			...
			String qname = jdbcTypeInformation.getFullyQualifiedJavaType().getFullyQualifiedName();
//			if(introspectedColumn.getActualColumnName().equals("account_status")){
//				log.info("xxx");
//			}
//			if(("java.lang.Short".equals(qname)||"java.lang.Byte".equals(qname))){
//				answer = typeMap.get(Types.INTEGER).getFullyQualifiedJavaType();
//			}else if ("java.lang.Integer".equals(qname)&& introspectedColumn.getLength() >= 10) {
//				answer = typeMap.get(Types.BIGINT).getFullyQualifiedJavaType();
//			} else {
